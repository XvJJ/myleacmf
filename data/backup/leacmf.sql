...
-- Records of admin
-- ----------------------------
INSERT INTO `admin` VALUES (1, 'admin', 'admin', 'd3e3aad7256f373a52a9cfb99bb54c98', 6, 'eefdda296378bda84ae9d969afe95103', 692, 1518177725, '127.0.0.1', 1, 1);
...
) ENGINE = InnoDB AUTO_INCREMENT = 102 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '节点表' ROW_FORMAT = Dynamic;
...
INSERT INTO `auth_rule` VALUES (87, 0, '/admin/meeting/index', '会议管理', 'fa fa-users', '', '', 1, 1516882158, 1518175363, 0, 1);
INSERT INTO `auth_rule` VALUES (88, 87, '/admin/meeting/lists', '会议列表', '', '', '', 0, 1516882211, 1516882211, 0, 1);
...
INSERT INTO `auth_rule` VALUES (101, 97, '/admin/room/delete', '会议室删除', '', '', '', 0, 1516883144, 1516883144, 0, 1);
...
CREATE TABLE `config`  (
  ...
  `extra` varchar(522) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '配置值',
...
) ENGINE = InnoDB AUTO_INCREMENT = 18 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统配置表' ROW_FORMAT = Dynamic;
...
-- Records of meeting
-- ----------------------------
INSERT INTO `meeting` VALUES (2, 1, '会议1', 2, 1518225060, 1, '', 1517919081, 1518177490, 1);
INSERT INTO `meeting` VALUES (3, 1, '会议2', 2, 1518224400, 2, '', 1518177664, 1518177664, 1);
INSERT INTO `meeting` VALUES (4, 1, '会议3', 2, 1518224400, 3, '', 1518180345, 1518180345, 1);
INSERT INTO `meeting` VALUES (5, 1, '会议4', 2, 1518224400, 2, '', 1518180544, 1518180544, 1);
INSERT INTO `meeting` VALUES (6, 1, '会议5', 2, 1518224400, 3, '', 1518180736, 1518180736, 1);
...
CREATE TABLE `msg`  (
  ...
  `msg` varchar(155) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `data` varchar(522) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
...
CREATE TABLE `sms`  (
  ...
  `mobile` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '接收信息的手机号',
  `code` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '验证码',
